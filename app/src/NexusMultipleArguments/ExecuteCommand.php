...
namespace Temporal\Samples\NexusMultipleArguments;
...
{
    protected const NAME = 'nexus-multiple-arguments';
    protected const DESCRIPTION = 'Same Nexus contract, but the handler workflow takes positional args (string, Language) instead of a HelloInput DTO';
