...
namespace Temporal\Samples\NexusContextPropagation;
...
{
    protected const NAME = 'nexus-context-propagation';
    protected const DESCRIPTION = 'Propagate caller workflow ID to the handler via Nexus operation headers';
